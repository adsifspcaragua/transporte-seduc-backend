...
| `Feature/Api/MensagensEmPortuguesTest.php` | Idioma das respostas: mensagens de validação (com o nome do campo em português) e os retornos gerados pelo Laravel — 401, 404 de rota, 404 de registro inexistente no route binding, 405 e 429. |
