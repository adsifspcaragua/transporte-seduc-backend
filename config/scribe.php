...
return [
    ...
    'title' => 'API Transporte SEDUC',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'Documentacao da API do sistema de transporte escolar da SEDUC.',
...
INTRO,
    ...
    'try_it_out' => [
        ...
        'base_url' => env('SCRIBE_TRY_IT_OUT_URL', env('SCRIBE_BASE_URL', config('app.url'))),
    ...
    'auth' => [
        ...
        'placeholder' => 'TOKEN_DE_ACESSO',

        // Any extra authentication-related info for your users. Markdown and HTML are supported.
        'extra_info' => 'Use <code>POST /api/auth/token</code> informando e-mail ou CPF e senha para gerar um token Bearer.',
    ],
    ...
    'groups' => [
        ...
        'order' => [
            ...
            'Estudantes',
            'Inscricoes',
            'Documentos da inscricao',
            'Instituicoes da inscricao',
            'Instituicoes',
            'Linhas',
            'Recadastro',
        ],
