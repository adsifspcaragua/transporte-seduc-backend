...
class StoreInscricaoInstituicaoRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'inscricao_id' => 'sometimes|integer|exists:inscricoes,id|unique:inscricao_instituicoes,inscricao_id',
