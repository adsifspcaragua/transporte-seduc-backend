...
class StorePeriodoRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'semestre' => [
                ...
                'integer',
                Rule::in([1, 2]),
                Rule::unique('periodos_reecadastro', 'semestre')->where('ano', $this->input('ano')),
            ],
    ...
    public function bodyParameters(): array
    {
        return [
            ...
            'observacoes' => ['description' => 'Observacoes internas sobre o periodo.', 'example' => 'Recadastro do primeiro semestre.'],
